        ...
        <div className="min-h-screen  w-full flex flex-col items-center bg-amber-50 p-5">
            ...
            <div className="mb-20 top-dest max-w-5xl w-full  mt-20 grid grid-cols-1 sm:grid-cols-2 p-5">
                <div className="left p-5 flex flex-col space-y-4">
                    ...
                    <Link to='/events' className="hover:scale-105 transform transition duration-200 w-30">
                        <button className="bg-orange-400 text-white px-3 py-2 rounded-md text-sm mt-3 flex items-center justify-center gap-2 cursor-pointer">View more
                            <FiArrowUpRight />
                        </button>
                    </Link>
                </div>
